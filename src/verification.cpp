...
std::unique_ptr<IVerification> Verify(
  const std::shared_ptr<types::IClass>& that,
  bool recursively
) {
  return (recursively)
    ? common::make_unique<RecursiveVerification>(
      that
    )
    : common::make_unique<NonRecursiveVerification>(
      that
    );
}
...
Iterator NonRecursiveVerification::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator RecursiveVerification::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
void AlwaysDoneVerificator::Done() const {
  return true;
}
...
OfExtension::OfExtension(
  ...
  instance_(
    std::static_pointer_cast<IExtension>(
      instance
    )
  ) {
  // Intentionally empty.
...
OfExtension::OfExtension(
  ...
  state_ = other.state_;
  constrained_primitive_verificator_ = other.constrained_primitive_verificator_;
}
...
std::unique_ptr<impl::IIterator> OfExtension::Clone() const {
    ...
    switch (state_) {
      case 0:
        ...
        if (
          ...
          || (instance_->supplemental_semantic_ids().value().size() >= 1)
        ) {
          state_ = 1;
          continue;
        }
      ...
      case 2:
        if (
          ...
          || (instance_->refers_to().value().size() >= 1)
        ) {
          state_ = 3;
          continue;
        }
...
OfAdministrativeInformation::OfAdministrativeInformation(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IAdministrativeInformation>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfAdministrativeInformation::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfAdministrativeInformation::Clone() const {
  return common::make_unique<
    OfAdministrativeInformation
  >(*this);
}
    ...
    switch (state_) {
      case 0:
        ...
        if (
          ...
          || (instance_->embedded_data_specifications().value().size() >= 1)
        ) {
          state_ = 1;
          continue;
        }
...
OfQualifier::OfQualifier(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IQualifier>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfQualifier::Clone() const {
  return common::make_unique<
    OfQualifier
  >(*this);
}
...
OfAssetAdministrationShell::OfAssetAdministrationShell(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IAssetAdministrationShell>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfAssetAdministrationShell::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfAssetAdministrationShell::Clone() const {
  return common::make_unique<
    OfAssetAdministrationShell
  >(*this);
}
    ...
    switch (state_) {
      case 0:
        ...
        if (
          ...
          || (instance_->extensions().value().size() >= 1)
        ) {
          state_ = 1;
          continue;
        }
      ...
      case 2:
        if (
          ...
          || (instance_->description().value().size() >= 1)
        ) {
          state_ = 3;
          continue;
        }
      ...
      case 4:
        if (
          ...
          || (instance_->display_name().value().size() >= 1)
        ) {
          state_ = 5;
          continue;
        }
      ...
      case 7:
        if (
          ...
          || (instance_->submodels().value().size() >= 1)
        ) {
          state_ = 8;
          continue;
        }
...
OfAssetInformation::OfAssetInformation(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IAssetInformation>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfAssetInformation::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfAssetInformation::Clone() const {
  return common::make_unique<
    OfAssetInformation
  >(*this);
}
                  ...
                  return (
                      ...
                      || (
                          (
                              ...
                              && specific_asset_id->name() == L"globalAssetId"
                              && specific_asset_id->value() == instance_->global_asset_id().value()
                          )
                      )
                  );
              },
              instance_->specific_asset_ids().value()
          )
        ) {
          state_ = 1;
          continue;
      ...
      case 1:
        if (
          (
              ...
              && (
                  !(instance_->specific_asset_ids().has_value())
                  || (instance_->specific_asset_ids().value().size() >= 1)
              )
          )
        ) {
          state_ = 2;
...
OfResource::OfResource(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IResource>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfResource::Clone() const {
  return common::make_unique<
    OfResource
  >(*this);
}
...
OfSpecificAssetId::OfSpecificAssetId(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<ISpecificAssetId>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfSpecificAssetId::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfSpecificAssetId::Clone() const {
  return common::make_unique<
    OfSpecificAssetId
  >(*this);
}
    ...
    switch (state_) {
      ...
      case 2:
        if (
          ...
          || (instance_->external_subject_id().value()->type() == types::ReferenceTypes::kExternalReference)
        ) {
          state_ = 3;
          continue;
        }
...
OfSubmodel::OfSubmodel(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<ISubmodel>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfSubmodel::Clone() const {
  return common::make_unique<
    OfSubmodel
  >(*this);
}
    ...
    switch (state_) {
      ...
      case 8:
        if (
          ...
          || (instance_->qualifiers().value().size() >= 1)
        ) {
          state_ = 9;
          continue;
        }
      ...
      case 11:
        if (
          ...
          || (instance_->submodel_elements().value().size() >= 1)
        ) {
          state_ = 12;
          continue;
        }
      ...
      case 12:
        if (
          ...
          || common::All(
              ...
              instance_->submodel_elements().value()
          )
        ) {
          state_ = 13;
          continue;
          ...
          || common::All(
              [](const std::shared_ptr<types::ISubmodelElement>& submodel_element) -> bool {
                  ...
                  || common::All(
                      ...
                      submodel_element->qualifiers().value()
                  );
              },
              instance_->submodel_elements().value()
          ))
...
OfRelationshipElement::OfRelationshipElement(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IRelationshipElement>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfRelationshipElement::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfRelationshipElement::Clone() const {
  return common::make_unique<
    OfRelationshipElement
  >(*this);
}
...
OfSubmodelElementList::OfSubmodelElementList(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<ISubmodelElementList>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfSubmodelElementList::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfSubmodelElementList::Clone() const {
  return common::make_unique<
    OfSubmodelElementList
  >(*this);
}
          ...
          || common::All(
              [](const std::shared_ptr<types::ISubmodelElement>& child) -> bool {
                  ...
                  || ReferenceKeyValuesEqual(
                      child->semantic_id().value(),
                      instance_->semantic_id_list_element().value()
                  );
              },
              instance_->value().value()
          )
        ...
        if (
          ...
          || ((
              ...
              && PropertiesOrRangesHaveValueType(
                  instance_->value().value(),
                  instance_->value_type_list_element().value()
              )
          ))
        ) {
          state_ = 16;
...
OfSubmodelElementCollection::OfSubmodelElementCollection(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<ISubmodelElementCollection>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfSubmodelElementCollection::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfSubmodelElementCollection::Clone() const {
  return common::make_unique<
    OfSubmodelElementCollection
  >(*this);
}
...
OfProperty::OfProperty(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IProperty>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfProperty::Clone() const {
  return common::make_unique<
    OfProperty
  >(*this);
}
...
OfMultiLanguageProperty::OfMultiLanguageProperty(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IMultiLanguageProperty>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfMultiLanguageProperty::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfMultiLanguageProperty::Clone() const {
  return common::make_unique<
    OfMultiLanguageProperty
  >(*this);
}
...
OfRange::OfRange(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IRange>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfRange::Clone() const {
  return common::make_unique<
    OfRange
  >(*this);
}
...
OfReferenceElement::OfReferenceElement(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IReferenceElement>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfReferenceElement::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfReferenceElement::Clone() const {
  return common::make_unique<
    OfReferenceElement
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfBlob::Clone() const {
  return common::make_unique<
    OfBlob
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfFile::Clone() const {
  return common::make_unique<
    OfFile
  >(*this);
}
...
OfAnnotatedRelationshipElement::OfAnnotatedRelationshipElement(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IAnnotatedRelationshipElement>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfAnnotatedRelationshipElement::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfAnnotatedRelationshipElement::Clone() const {
  return common::make_unique<
    OfAnnotatedRelationshipElement
  >(*this);
}
    ...
    switch (state_) {
      ...
      case 11:
        if (
          ...
          || (instance_->annotations().value().size() >= 1)
        ) {
          state_ = 12;
          continue;
        }
...
OfEntity::OfEntity(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IEntity>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfEntity::Clone() const {
  return common::make_unique<
    OfEntity
  >(*this);
}
    ...
    switch (state_) {
      ...
      case 11:
        if (
          ...
          || (instance_->statements().value().size() >= 1)
        ) {
          state_ = 12;
          continue;
        }
...
OfEventPayload::OfEventPayload(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IEventPayload>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfEventPayload::Clone() const {
  return common::make_unique<
    OfEventPayload
  >(*this);
}
...
OfBasicEventElement::OfBasicEventElement(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IBasicEventElement>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfBasicEventElement::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfBasicEventElement::Clone() const {
  return common::make_unique<
    OfBasicEventElement
  >(*this);
}
    ...
    switch (state_) {
      ...
      case 13:
        if (
          ...
          || IsModelReferenceToReferable(
              instance_->message_broker().value()
          )
        ) {
          state_ = 14;
          continue;
...
OfOperation::OfOperation(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IOperation>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfOperation::Clone() const {
  return common::make_unique<
    OfOperation
  >(*this);
}
    ...
    switch (state_) {
      ...
      case 12:
        if (
          ...
          || (instance_->input_variables().value().size() >= 1)
        ) {
          state_ = 13;
          continue;
        }
      ...
      case 13:
        if (
          ...
          || (instance_->output_variables().value().size() >= 1)
        ) {
          state_ = 14;
          continue;
        }
      ...
      case 14:
        if (
          ...
          || (instance_->inoutput_variables().value().size() >= 1)
        ) {
          state_ = 15;
          continue;
        }
...
OfOperationVariable::OfOperationVariable(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IOperationVariable>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfOperationVariable::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfOperationVariable::Clone() const {
  return common::make_unique<
    OfOperationVariable
  >(*this);
}
...
OfCapability::OfCapability(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<ICapability>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfCapability::Clone() const {
  return common::make_unique<
    OfCapability
  >(*this);
}
...
OfConceptDescription::OfConceptDescription(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IConceptDescription>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfConceptDescription::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfConceptDescription::Clone() const {
  return common::make_unique<
    OfConceptDescription
  >(*this);
}
    ...
    switch (state_) {
      ...
      case 7:
        if (
          ...
          || (instance_->is_case_of().value().size() >= 1)
        ) {
          state_ = 8;
          continue;
        }
        ...
        if (
          ...
          || ((
              DataSpecificationIec61360sHaveDefinitionAtLeastInEnglish(
                  instance_->embedded_data_specifications().value()
              )
      ...
      case 9:
        if (
          !((
              (instance_->category().has_value())
              && instance_->category().value() == L"QUALIFIER_TYPE"
              && (instance_->embedded_data_specifications().has_value())
          ))
      ...
      case 10:
        if (
          !((
              (instance_->category().has_value())
              && instance_->category().value() == L"DOCUMENT"
              && (instance_->embedded_data_specifications().has_value())
          ))
      ...
      case 11:
        if (
          !((
              (instance_->category().has_value())
              && instance_->category().value() == L"REFERENCE"
              && (instance_->embedded_data_specifications().has_value())
          ))
      ...
      case 12:
        if (
          !((
              ...
              && (
                  (
                      instance_->category().value() == L"PROPERTY"
                      || instance_->category().value() == L"VALUE"
                  )
              )
              && (instance_->embedded_data_specifications().has_value())
          ))
...
OfReference::OfReference(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IReference>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfReference::Clone() const {
  return common::make_unique<
    OfReference
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfKey::Clone() const {
  return common::make_unique<
    OfKey
  >(*this);
}
...
OfLangStringNameType::OfLangStringNameType(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<ILangStringNameType>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfLangStringNameType::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfLangStringNameType::Clone() const {
  return common::make_unique<
    OfLangStringNameType
  >(*this);
}
...
OfLangStringTextType::OfLangStringTextType(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<ILangStringTextType>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfLangStringTextType::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfLangStringTextType::Clone() const {
  return common::make_unique<
    OfLangStringTextType
  >(*this);
}
...
OfEnvironment::OfEnvironment(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IEnvironment>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfEnvironment::Clone() const {
  return common::make_unique<
    OfEnvironment
  >(*this);
}
    ...
    switch (state_) {
      case 0:
        ...
        if (
          ...
          || (instance_->concept_descriptions().value().size() >= 1)
        ) {
          state_ = 1;
          continue;
        }
      ...
      case 2:
        if (
          ...
          || (instance_->asset_administration_shells().value().size() >= 1)
        ) {
          state_ = 3;
          continue;
        }
...
class OfEmbeddedDataSpecification : public impl::IVerificator {
 public:
  ...
  bool Done() const override;
  const Error& Get() const override;
  Error& GetMutable() const override;
  long Index() const override;
...
OfValueReferencePair::OfValueReferencePair(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IValueReferencePair>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfValueReferencePair::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfValueReferencePair::Clone() const {
  return common::make_unique<
    OfValueReferencePair
  >(*this);
}
...
OfValueList::OfValueList(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IValueList>(
      instance
    )
  ) {
  // Intentionally empty.
...
std::unique_ptr<impl::IIterator> OfValueList::Clone() const {
  return common::make_unique<
    OfValueList
  >(*this);
}
...
OfLangStringPreferredNameTypeIec61360::OfLangStringPreferredNameTypeIec61360(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<ILangStringPreferredNameTypeIec61360>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfLangStringPreferredNameTypeIec61360::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfLangStringPreferredNameTypeIec61360::Clone() const {
  return common::make_unique<
    OfLangStringPreferredNameTypeIec61360
  >(*this);
}
...
OfLangStringShortNameTypeIec61360::OfLangStringShortNameTypeIec61360(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<ILangStringShortNameTypeIec61360>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfLangStringShortNameTypeIec61360::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfLangStringShortNameTypeIec61360::Clone() const {
  return common::make_unique<
    OfLangStringShortNameTypeIec61360
  >(*this);
}
...
OfLangStringDefinitionTypeIec61360::OfLangStringDefinitionTypeIec61360(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<ILangStringDefinitionTypeIec61360>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfLangStringDefinitionTypeIec61360::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfLangStringDefinitionTypeIec61360::Clone() const {
  return common::make_unique<
    OfLangStringDefinitionTypeIec61360
  >(*this);
}
...
OfDataSpecificationIec61360::OfDataSpecificationIec61360(
  ...
  // for the verification functions based on the shared pointer.
  instance_(
    std::static_pointer_cast<IDataSpecificationIec61360>(
      instance
    )
  ) {
  // Intentionally empty.
...
void bool OfDataSpecificationIec61360::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfDataSpecificationIec61360::Clone() const {
  return common::make_unique<
    OfDataSpecificationIec61360
  >(*this);
}
    ...
    switch (state_) {
      ...
      case 2:
        if (
          ...
          || (instance_->definition().value().size() >= 1)
        ) {
          state_ = 3;
          continue;
        }
      ...
      case 4:
        if (
          ...
          || (instance_->short_name().value().size() >= 1)
        ) {
          state_ = 5;
          continue;
        }
...
std::unique_ptr<impl::IVerificator> NewNonRecursiveVerificator(
  const std::shared_ptr<IClass>& instance
) {
...
Error& RecursiveVerificator::GetMutable() const {
  #ifdef DEBUG
  if (Done()) {
    throw std::logic_error(
  ...
  while (true) {
    switch (state_) {
      ...
      case 2:
        ...
        std::unique_ptr<IDescent> descent(
          iteration::Descend(*instance_)
        );
        iterator_ = std::move(descent->begin());
        iterator_end_ = std::move(descent->end());
...
std::wregex ConstructMatchesXsDateTimeUtc() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      ...
      month_frag = L"((0[1-9])|(1[0-2]))"
      day_frag = common::Concat(
        L"((0[1-9])|([12]",
        digit,
        L")|(3[01]))"
      )
      hour_frag = common::Concat(
        L"(([01]",
        digit,
        L")|(2[0-3]))"
      )
      minute_frag = common::Concat(
        L"[0-5]",
        digit
      )
      second_frag = common::Concat(
        L"([0-5]",
        digit,
        L")(\\.",
        digit,
      ...
      end_of_day_frag = L"24:00:00(\\.0+)?"
      timezone_frag = L"(Z|\\+00:00|-00:00)"
      date_time_lexical_rep = common::Concat(
        year_frag,
        L"-",
        month_frag,
        L"-",
...
std::wregex ConstructMatchesMimeType() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      ...
      subtype = common::Concat(
        token
      )
      ows = L"[ \\t]*"
      obs_text = L"[\\x80-\\xff]"
      qd_text = common::Concat(
        L"([\\t !#-\\[\\]-~]|",
        obs_text,
        L")"
      )
      quoted_pair = common::Concat(
        L"\\\\([\\t !-~]|",
        obs_text,
        L")"
      )
      quoted_string = common::Concat(
        L"\"(",
        qd_text,
        L"|",
        quoted_pair,
...
std::wregex ConstructMatchesRfc8089Path() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      h16 = L"[0-9A-Fa-f]{1,4}"
      dec_octet = L"([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])"
      ipv4address = common::Concat(
        dec_octet,
        L"\\.",
        dec_octet,
        L"\\.",
      ...
      unreserved = L"[a-zA-Z0-9\\-._~]"
      sub_delims = L"[!$&'()*+,;=]"
      ipvfuture = common::Concat(
        L"[vV][0-9A-Fa-f]+\\.(",
        unreserved,
        L"|",
        sub_delims,
      ...
      pct_encoded = L"%[0-9A-Fa-f][0-9A-Fa-f]"
      reg_name = common::Concat(
        L"(",
        unreserved,
        L"|",
        pct_encoded,
      ...
      segment_nz = common::Concat(
        L"(",
        pchar,
        L")+"
      )
      segment = common::Concat(
        L"(",
        pchar,
        L")*"
      )
      path_absolute = common::Concat(
        L"/(",
        segment_nz,
        L"(/",
        segment,
      ...
      auth_path = common::Concat(
        L"(",
        file_auth,
        L")?",
        path_absolute
      )
      local_path = common::Concat(
        path_absolute
      )
      file_hier_part = common::Concat(
        L"(//",
        auth_path,
        L"|",
        local_path,
...
std::wregex ConstructMatchesBcp47() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      alphanum = L"[a-zA-Z0-9]"
      singleton = L"[0-9A-WY-Za-wy-z]"
      extension = common::Concat(
        singleton,
        L"(-(",
        alphanum,
        L"){2,8})+"
      )
      extlang = L"[a-zA-Z]{3}(-[a-zA-Z]{3}){2}"
      irregular = L"(en-GB-oed|i-ami|i-bnn|i-default|i-enochian|i-hak|i-klingon|i-lux|i-mingo|i-navajo|i-pwn|i-tao|i-tay|i-tsu|sgn-BE-FR|sgn-BE-NL|sgn-CH-DE)"
      regular = L"(art-lojban|cel-gaulish|no-bok|no-nyn|zh-guoyu|zh-hakka|zh-min|zh-min-nan|zh-xiang)"
      grandfathered = common::Concat(
        L"(",
        irregular,
        L"|",
        regular,
      ...
      language = common::Concat(
        L"([a-zA-Z]{2,3}(-",
        extlang,
        L")?|[a-zA-Z]{4}|[a-zA-Z]{5,8})"
      )
      script = L"[a-zA-Z]{4}"
      region = L"([a-zA-Z]{2}|[0-9]{3})"
      variant = common::Concat(
        L"((",
        alphanum,
        L"){5,8}|[0-9](",
        alphanum,
      ...
      privateuse = common::Concat(
        L"[xX](-(",
        alphanum,
        L"){1,8})+"
      )
      langtag = common::Concat(
        language,
        L"(-",
        script,
        L")?(-",
...
bool LangStringsHaveUniqueLanguages(
  ...
  for (const std::shared_ptr<types::IAbstractLangString>& lang_string : lang_strings) {
    const std::wstring& language = lang_string->language();

    if (language_set.contains(language)) {
      return false;
    }
...
std::wregex ConstructMatchesXmlSerializableString() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      pattern = L"^([\\x09\\x0a\\x0d\\x20-\\ud7ff\\ue000-\\ufffd]|\\ud800[\\udc00-\\udfff]|[\\ud801-\\udbfe][\\udc00-\\udfff]|\\udbff[\\udc00-\\udfff])*$"
      return std::wregex(
        pattern
      );

    case 4:
      pattern = L"^[\\x09\\x0a\\x0d\\x20-\ud7ff\ue000-\ufffd\U00010000-\U0010ffff]*$"
      return std::wregex(
        pattern
      );
  }
...
std::wregex ConstructMatchesXsAnyUri() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      scheme = L"[a-zA-Z][a-zA-Z0-9+\\-.]*"
      ucschar = L"([\\xa0-\\ud7ff\\uf900-\\ufdcf\\ufdf0-\\uffef]|\\ud800[\\udc00-\\udfff]|[\\ud801-\\ud83e][\\udc00-\\udfff]|\\ud83f[\\udc00-\\udffd]|\\ud840[\\udc00-\\udfff]|[\\ud841-\\ud87e][\\udc00-\\udfff]|\\ud87f[\\udc00-\\udffd]|\\ud880[\\udc00-\\udfff]|[\\ud881-\\ud8be][\\udc00-\\udfff]|\\ud8bf[\\udc00-\\udffd]|\\ud8c0[\\udc00-\\udfff]|[\\ud8c1-\\ud8fe][\\udc00-\\udfff]|\\ud8ff[\\udc00-\\udffd]|\\ud900[\\udc00-\\udfff]|[\\ud901-\\ud93e][\\udc00-\\udfff]|\\ud93f[\\udc00-\\udffd]|\\ud940[\\udc00-\\udfff]|[\\ud941-\\ud97e][\\udc00-\\udfff]|\\ud97f[\\udc00-\\udffd]|\\ud980[\\udc00-\\udfff]|[\\ud981-\\ud9be][\\udc00-\\udfff]|\\ud9bf[\\udc00-\\udffd]|\\ud9c0[\\udc00-\\udfff]|[\\ud9c1-\\ud9fe][\\udc00-\\udfff]|\\ud9ff[\\udc00-\\udffd]|\\uda00[\\udc00-\\udfff]|[\\uda01-\\uda3e][\\udc00-\\udfff]|\\uda3f[\\udc00-\\udffd]|\\uda40[\\udc00-\\udfff]|[\\uda41-\\uda7e][\\udc00-\\udfff]|\\uda7f[\\udc00-\\udffd]|\\uda80[\\udc00-\\udfff]|[\\uda81-\\udabe][\\udc00-\\udfff]|\\udabf[\\udc00-\\udffd]|\\udac0[\\udc00-\\udfff]|[\\udac1-\\udafe][\\udc00-\\udfff]|\\udaff[\\udc00-\\udffd]|\\udb00[\\udc00-\\udfff]|[\\udb01-\\udb3e][\\udc00-\\udfff]|\\udb3f[\\udc00-\\udffd]|\\udb44[\\udc00-\\udfff]|[\\udb45-\\udb7e][\\udc00-\\udfff]|\\udb7f[\\udc00-\\udffd])"
      iunreserved = common::Concat(
        L"([a-zA-Z0-9\\-._~]|",
        ucschar,
        L")"
      )
      ...
      isegment = common::Concat(
        L"(",
        ipchar,
        L")*"
      )
      ipath_abempty = common::Concat(
        L"(/",
        isegment,
        L")*"
      )
      isegment_nz = common::Concat(
        L"(",
        ipchar,
        L")+"
      )
      ipath_absolute = common::Concat(
        L"/(",
        isegment_nz,
        L"(/",
        isegment,
      ...
      ipath_rootless = common::Concat(
        isegment_nz,
        L"(/",
        isegment,
        L")*"
      )
      ipath_empty = common::Concat(
        L"(",
        ipchar,
        L"){0}"
      )
      ihier_part = common::Concat(
        L"(//",
        iauthority,
        ipath_abempty,
        L"|",
      ...
      ifragment = common::Concat(
        L"(",
        ipchar,
        L"|[/?])*"
      )
      isegment_nz_nc = common::Concat(
        L"(",
        iunreserved,
        L"|",
        pct_encoded,
      ...
      ipath_noscheme = common::Concat(
        isegment_nz_nc,
        L"(/",
        isegment,
        L")*"
      )
      irelative_part = common::Concat(
        L"(//",
        iauthority,
        ipath_abempty,
        L"|",
    ...
    case 4:
      scheme = L"[a-zA-Z][a-zA-Z0-9+\\-.]*"
      ucschar = L"[\\xa0-\ud7ff\uf900-\ufdcf\ufdf0-\uffef\U00010000-\U0001fffd\U00020000-\U0002fffd\U00030000-\U0003fffd\U00040000-\U0004fffd\U00050000-\U0005fffd\U00060000-\U0006fffd\U00070000-\U0007fffd\U00080000-\U0008fffd\U00090000-\U0009fffd\U000a0000-\U000afffd\U000b0000-\U000bfffd\U000c0000-\U000cfffd\U000d0000-\U000dfffd\U000e1000-\U000efffd]"
      iunreserved = common::Concat(
        L"([a-zA-Z0-9\\-._~]|",
        ucschar,
        L")"
      ...
      iprivate = L"[\ue000-\uf8ff\U000f0000-\U000ffffd\U00100000-\U0010fffd]"
      iquery = common::Concat(
        L"(",
        ipchar,
        L"|",
...
std::wregex ConstructMatchesXsBase64Binary() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      ...
      b16_char = L"[AEIMQUYcgkosw048]"
      b16 = common::Concat(
        b16_char,
        L"\\x20?"
      )
      b64_char = L"[A-Za-z0-9+/]"
      b64 = common::Concat(
        b64_char,
        L"\\x20?"
      )
      b64quad = common::Concat(
        L"(",
        b64,
        b64,
        b64,
      ...
      padded_8 = common::Concat(
        b64,
        b04,
        L"= ?="
      )
      padded_16 = common::Concat(
        b64,
        b64,
        b16,
        L"="
      )
      b64final = common::Concat(
        L"(",
        b64_final_quad,
        L"|",
        padded_16,
...
std::wregex ConstructMatchesXsDate() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      ...
      date_lexical_rep = common::Concat(
        year_frag,
        L"-",
        month_frag,
        L"-",
...
std::wregex ConstructMatchesXsDecimal() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      digit = L"[0-9]"
      unsigned_no_decimal_pt_numeral = common::Concat(
        digit,
        L"+"
      )
      no_decimal_pt_numeral = common::Concat(
        L"(\\+|-)?",
        unsigned_no_decimal_pt_numeral
      )
      frac_frag = common::Concat(
        digit,
        L"+"
      )
      unsigned_decimal_pt_numeral = common::Concat(
        L"(",
        unsigned_no_decimal_pt_numeral,
        L"\\.",
        frac_frag,
      ...
      decimal_pt_numeral = common::Concat(
        L"(\\+|-)?",
        unsigned_decimal_pt_numeral
      )
      decimal_lexical_rep = common::Concat(
        L"(",
        decimal_pt_numeral,
        L"|",
...
std::wregex ConstructMatchesXsDouble() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      double_rep = L"((\\+|-)?([0-9]+(\\.[0-9]*)?|\\.[0-9]+)([Ee](\\+|-)?[0-9]+)?|-?INF|NaN)"
      pattern = common::Concat(
        L"^",
        double_rep,
        L"$"
...
std::wregex ConstructMatchesXsDuration() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      duration_rep = L"-?P((([0-9]+Y([0-9]+M)?([0-9]+D)?|([0-9]+M)([0-9]+D)?|([0-9]+D))(T(([0-9]+H)([0-9]+M)?([0-9]+(\\.[0-9]+)?S)?|([0-9]+M)([0-9]+(\\.[0-9]+)?S)?|([0-9]+(\\.[0-9]+)?S)))?)|(T(([0-9]+H)([0-9]+M)?([0-9]+(\\.[0-9]+)?S)?|([0-9]+M)([0-9]+(\\.[0-9]+)?S)?|([0-9]+(\\.[0-9]+)?S))))"
      pattern = common::Concat(
        L"^",
        duration_rep,
        L"$"
...
std::wregex ConstructMatchesXsFloat() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      float_rep = L"((\\+|-)?([0-9]+(\\.[0-9]*)?|\\.[0-9]+)([Ee](\\+|-)?[0-9]+)?|-?INF|NaN)"
      pattern = common::Concat(
        L"^",
        float_rep,
        L"$"
...
std::wregex ConstructMatchesXsGDay() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      g_day_lexical_rep = L"---(0[1-9]|[12][0-9]|3[01])(Z|(\\+|-)((0[0-9]|1[0-3]):[0-5][0-9]|14:00))?"
      pattern = common::Concat(
        L"^",
        g_day_lexical_rep,
        L"$"
...
std::wregex ConstructMatchesXsGMonth() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      g_month_lexical_rep = L"--(0[1-9]|1[0-2])(Z|(\\+|-)((0[0-9]|1[0-3]):[0-5][0-9]|14:00))?"
      pattern = common::Concat(
        L"^",
        g_month_lexical_rep,
        L"$"
...
std::wregex ConstructMatchesXsGMonthDay() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      g_month_day_rep = L"--(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])(Z|(\\+|-)((0[0-9]|1[0-3]):[0-5][0-9]|14:00))?"
      pattern = common::Concat(
        L"^",
        g_month_day_rep,
        L"$"
...
std::wregex ConstructMatchesXsGYear() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      g_year_rep = L"-?([1-9][0-9]{3,}|0[0-9]{3})(Z|(\\+|-)((0[0-9]|1[0-3]):[0-5][0-9]|14:00))?"
      pattern = common::Concat(
        L"^",
        g_year_rep,
        L"$"
...
std::wregex ConstructMatchesXsGYearMonth() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      g_year_month_rep = L"-?([1-9][0-9]{3,}|0[0-9]{3})-(0[1-9]|1[0-2])(Z|(\\+|-)((0[0-9]|1[0-3]):[0-5][0-9]|14:00))?"
      pattern = common::Concat(
        L"^",
        g_year_month_rep,
        L"$"
...
std::wregex ConstructMatchesXsTime() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      time_rep = L"(([01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9](\\.[0-9]+)?|(24:00:00(\\.0+)?))(Z|(\\+|-)((0[0-9]|1[0-3]):[0-5][0-9]|14:00))?"
      pattern = common::Concat(
        L"^",
        time_rep,
        L"$"
...
std::wregex ConstructMatchesXsNonNegativeInteger() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      non_negative_integer_rep = L"(-0|\\+?[0-9]+)"
      pattern = common::Concat(
        L"^",
...
std::wregex ConstructMatchesXsPositiveInteger() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      positive_integer_rep = L"\\+?0*[1-9][0-9]*"
      pattern = common::Concat(
        L"^",
...
std::wregex ConstructMatchesXsUnsignedLong() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      unsigned_long_rep = L"(-0|\\+?0*[0-9]{1,20})"
      pattern = common::Concat(
        L"^",
        unsigned_long_rep,
        L"$"
...
std::wregex ConstructMatchesXsUnsignedInt() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      unsigned_int_rep = L"(-0|\\+?0*[0-9]{1,10})"
      pattern = common::Concat(
        L"^",
        unsigned_int_rep,
        L"$"
...
std::wregex ConstructMatchesXsUnsignedShort() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      unsigned_short_rep = L"(-0|\\+?0*[0-9]{1,5})"
      pattern = common::Concat(
        L"^",
        unsigned_short_rep,
        L"$"
...
std::wregex ConstructMatchesXsUnsignedByte() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      unsigned_byte_rep = L"(-0|\\+?0*[0-9]{1,3})"
      pattern = common::Concat(
        L"^",
        unsigned_byte_rep,
        L"$"
...
std::wregex ConstructMatchesXsNonPositiveInteger() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      non_positive_integer_rep = L"(\\+0|0|-[0-9]+)"
      pattern = common::Concat(
        L"^",
...
std::wregex ConstructMatchesXsNegativeInteger() {
  ...
  switch (sizeof(wchar_t)) {
    case 2:
      negative_integer_rep = L"(-0*[1-9][0-9]*)"
      pattern = common::Concat(
        L"^",
...
bool IsXsDate(
  ...
  try {
    year = std::stoll(matched[1].str());
  } catch (const std::invalid_argument& exception) {
    std::wstringstream wss;
    wss
      << "Unexpected unparsable year from the regex match: "
      << matched[1].str();
    ...
    wss
      ...
      << (
        ...
        "in the SDK, but eventually lacked time for it. Please let the developers "
  ...
  try {
    month = std::stoi(matched[2].str());
  } catch (const std::invalid_argument& exception) {
    std::wstringstream wss;
    wss
      << "Unexpected unparsable month from the regex match: "
      << matched[2].str();
    ...
    std::wstringstream wss;
    wss
      << "The month is unexpectedly out of range for integers: "
      << matched[2].str();
  ...
  try {
    month = std::stoi(matched[3].str());
  } catch (const std::invalid_argument& exception) {
    std::wstringstream wss;
    wss
      << "Unexpected unparsable day from the regex match: "
      << matched[3].str();
    ...
    std::wstringstream wss;
    wss
      << "The day is unexpectedly out of range for integers: "
      << matched[3].str();
...
bool IsXsDouble(const std::wstring& value) {
  ...
  try {
    if (sizeof(double) == 8) {
      const double _ = std::stod(value);
    } else if (sizeof(long double) == 8) {
      const long double _ = std::stold(value);
    } else {
      std::stringstream ss;
      ss
...
bool IsXsLong(const std::wstring& value) {
  ...
  try {
    if (sizeof(long) == 8) {
      const long _ = std::stol(value);
    } else if (sizeof(long long) == 8) {
      const long long _ = std::stoll(value);
    } else {
      std::stringstream ss;
      ss
...
bool IsXsUnsignedLong(const std::wstring& value) {
  ...
  try {
    if (sizeof(unsigned long) == 8) {
      const unsigned long _ = std::stoul(value);
    } else if (sizeof(unsigned long long) == 8) {
      const unsigned long long _ = std::stoull(value);
    } else {
      std::stringstream ss;
      ss
...
> ConstructDataTypeDefXsdToValueConsistency() {
  ...
  > result = {
    {
      types::DataTypeDefXsd::AnyUri,
      MatchesXsAnyUri
    },
	{
      types::DataTypeDefXsd::Base64Binary,
    ...
    {
      types::DataTypeDefXsd::GDay,
      MatchesXsGDay
    },
    {
      types::DataTypeDefXsd::GMonth,
      MatchesXsGMonth
    },
    {
      types::DataTypeDefXsd::GMonthDay,
      IsXsGMonthDay
    },
    {
      types::DataTypeDefXsd::GYear,
      MatchesXsGYear
    },
    {
      types::DataTypeDefXsd::GYearMonth,
      MatchesXsGYearMonth
    },
    {
      types::DataTypeDefXsd::HexBinary,
      MatchesXsHexBinary
    },
    {
    ...
    {
      types::DataTypeDefXsd::NegativeInteger,
      MatchesXsNegativeInteger
    },
    {
      types::DataTypeDefXsd::NonNegativeInteger,
      MatchesXsNonNegativeInteger
    },
    {
      types::DataTypeDefXsd::NonPositiveInteger,
      MatchesXsNonPositiveInteger
    },
    {
      types::DataTypeDefXsd::PositiveInteger,
      MatchesXsPositiveInteger
    },
    {
    ...
    {
      types::DataTypeDefXsd::UnsignedByte,
      IsXsUnsignedByte
    },
    {
      types::DataTypeDefXsd::UnsignedInt,
      IsXsUnsignedInt
    },
    {
      types::DataTypeDefXsd::UnsignedLong,
      IsXsUnsignedLong
    },
    {
      types::DataTypeDefXsd::UnsignedShort,
      IsXsUnsignedShort
    }
  };
...
bool ValueConsistentWithXsdType(
  ...
  if (it == kDataTypeDefXsdToValueConsistency.end()) {
    ...
    ss
      ...
      << "types::DataTypeDefXsd, but got: " << value_type;
    throw std::invalid_argument(ss.str());
  }

  const std::function<bool(const std::wstring&)>& func(*it);
...
bool IdShortsAreUnique(
  ...
  for (const std::shared_ptr<types::IReferable> referable : referables) {
    ...
    if (referable.has_value()) {
      if (id_short_set.contains(*referable)) {
        return false;
      }

      id_short_set.insert(*referable);
    }
  }
  ...
  if (input_variables.has_value()) {
    ...
    for (const std::shared_ptr<types::IOperationVariable>& variable : variables) {
      ...
      if (id_short.has_value()) {
        if (id_short_set.contains(*id_short)) {
          return false;
        }
...
bool SubmodelElementsHaveIdenticalSemanticIds(
  ...
  for (const std::shared_ptr<types::ISubmodelElement>& element : elements) {
    const common::optional<std::shared_ptr<types::IReference> >& this_semantic_id(
      element->semantic_id()
    );
...
> ConstructAasSubmodelElementToIs() {
  ...
  > result = {
    {
      types::AasSubmodelElements::AnnotatedRelationshipElement,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsAnnotatedRelationshipElement(*element);
      }
    },
    {
      types::AasSubmodelElements::BasicEventElement,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsBasicEventElement(*element);
      }
    },
    {
      types::AasSubmodelElements::Blob,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsBlob(*element);
      }
    },
    {
      types::AasSubmodelElements::Capability,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsCapability(*element);
      }
    },
    {
      types::AasSubmodelElements::DataElement,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsDataElement(*element);
      }
    },
    {
      types::AasSubmodelElements::Entity,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsEntity(*element);
      }
    },
    {
      types::AasSubmodelElements::EventElement,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsEventElement(*element);
      }
    },
    {
      types::AasSubmodelElements::File,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsFile(*element);
      }
    },
    {
      types::AasSubmodelElements::MultiLanguageProperty,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsMultiLanguageProperty(*element);
      }
    },
    {
      types::AasSubmodelElements::Operation,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsOperation(*element);
      }
    },
    {
      types::AasSubmodelElements::Property,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsProperty(*element);
      }
    },
    {
      types::AasSubmodelElements::Range,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsRange(*element);
      }
    },
    {
      types::AasSubmodelElements::ReferenceElement,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsReferenceElement(*element);
      }
    },
    {
      types::AasSubmodelElements::RelationshipElement,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsRelationshipElement(*element);
      }
    },
    {
      types::AasSubmodelElements::SubmodelElement,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsSubmodelElement(*element);
      }
    },
    {
      types::AasSubmodelElements::SubmodelElementList,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsSubmodelElementList(*element);
      }
    },
    {
      types::AasSubmodelElements::SubmodelElementCollection,
      [](const std::shared_ptr<types::ISubmodelElement>& element) {
        return casting::IsSubmodelElementCollection(*element);
      }
    }
  };
...
bool SubmodelElementIsOfType(
  ...
  if (it == kAasSubmodelElementToIs.end()) {
    std::stringstream ss;
    ss << "Unexpected element type: " << element_type;
    throw std::invalid_argument(ss.str());
  }
...
bool PropertiesOrRangesHaveValueType(
  ...
  for (const std::shared_ptr<types::ISubmodelElement>& element : elements) {
    if (casting::IsProperty(*element) || casting::IsRange(*element)) {
...
bool DataSpecificationIec61360sForPropertyOrValueHaveAppropriateDataType(
  ...
  for (const auto& embedded_data_specification : embedded_data_specifications) {
    const std::shared_ptr<IDataSpecificationContent>& content(
    ...
    > maybe_iec61360(
      casting::AsDataSpecificationIec61360(
        content
      )
    );

    if (maybe_iec61360.has_value()) {
      const std::shared_ptr<types::IDataSpecificationIec61360>& iec61360(
        *maybe_iec61360
      );

      const common::optional<DataTypeIec61360>& data_type(
        iec61360->data_type()
      );

      if (
        !data_type.has_value()
        || !constants::kDataTypeIec61360ForPropertyOrValue.contains(*data_type)
      ) {
        return false;
      }
    }
...
bool DataSpecificationIec61360sForReferenceHaveAppropriateDataType(
  ...
  for (const auto& embedded_data_specification : embedded_data_specifications) {
    ...
    if (maybe_iec61360.has_value()) {
      ...
      if (
        !data_type.has_value()
        || !constants::kDataTypeIec61360ForReference.contains(*data_type)
      ) {
        return false;
      }
    }
...
bool DataSpecificationIec61360sForDocumentHaveAppropriateDataType(
  ...
  for (const auto& embedded_data_specification : embedded_data_specifications) {
    ...
    if (maybe_iec61360.has_value()) {
      ...
      if (
        !data_type.has_value()
        || !constants::kDataTypeIec61360ForDocument.contains(*data_type)
      ) {
        return false;
      }
    }
...
void OfNonEmptyXmlSerializableString::Done() {
  return done_;
}
...
std::unique_ptr<impl::IIterator> OfNonEmptyXmlSerializableString::Clone() const {
  return common::make_unique<
    OfNonEmptyXmlSerializableString
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfDateTimeUtc::Clone() const {
  return common::make_unique<
    OfDateTimeUtc
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfDuration::Clone() const {
  return common::make_unique<
    OfDuration
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfIdentifier::Clone() const {
  return common::make_unique<
    OfIdentifier
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfValueTypeIec61360::Clone() const {
  return common::make_unique<
    OfValueTypeIec61360
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfNameType::Clone() const {
  return common::make_unique<
    OfNameType
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfVersionType::Clone() const {
  return common::make_unique<
    OfVersionType
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfRevisionType::Clone() const {
  return common::make_unique<
    OfRevisionType
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfLabelType::Clone() const {
  return common::make_unique<
    OfLabelType
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfMessageTopicType::Clone() const {
  return common::make_unique<
    OfMessageTopicType
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfBcp47LanguageTag::Clone() const {
  return common::make_unique<
    OfBcp47LanguageTag
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfContentType::Clone() const {
  return common::make_unique<
    OfContentType
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfPathType::Clone() const {
  return common::make_unique<
    OfPathType
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfQualifierType::Clone() const {
  return common::make_unique<
    OfQualifierType
  >(*this);
}
...
std::unique_ptr<impl::IIterator> OfIdShortType::Clone() const {
  return common::make_unique<
    OfIdShortType
  >(*this);
}
...
Iterator OfNonEmptyXmlSerializableString::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfDateTimeUtc::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfIdentifier::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfValueTypeIec61360::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfVersionType::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfRevisionType::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfLabelType::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfMessageTopicType::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfBcp47LanguageTag::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfContentType::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfQualifierType::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfValueDataType::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
...
Iterator OfIdShortType::end() const {
  return Iterator(common::make_unique<AlwaysDoneVerificator>());
}
