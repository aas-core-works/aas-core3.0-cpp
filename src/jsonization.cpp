...
> DeserializeBool(
  ...
  if (!json.is_boolean()) {
    std::wostringstream wss;
    wss
      << "Expected a boolean, but got a value of type: "
    ...
    >(
      common::nullopt,
      common::make_optional<DeserializationError>(wss.str())
    );
  }
...
> DeserializeInt64(
  ...
  if (!json.is_number()) {
    std::wostringstream wss;
    wss
      << "Expected an integer number, but got a value of type: "
      << common::Utf8ToWstring(json.type_name());
  ...
  if (json.is_number_unsigned()) {
    std::wostringstream wss;
    wss
      << "Expected a 64-bit integer number, "
      << "but got an unsigned integer number which does not fit in that range: "
      << json.get<nlohmann::json::number_unsigned_t>();
  ...
  const bool is_integer(
    std::modf(number, &intpart) == 0
  );
  if (is_integer) {
    std::wostringstream wss;
    wss
      << "Expected a 64-bit integer number, "
      << "but got an integer number which does not fit in that range: "
      << number;
...
std::pair<
  ...
  std::unique_ptr<DeserializationError>
> DeserializeDouble(
  const nlohmann::json& json
) {
  if (!json.is_number()) {
    std::wostringstream wss;
    wss
      << "Expected a number, but got a value of type: "
      << common::Utf8ToWstring(json.type_name());
...
> DeserializeByteArray(
  ...
  if (!json.is_string()) {
    std::wostringstream wss;
    wss
      << "Expected a base64-encoded byte array as a string, "
  ...
  common::optional<std::vector<uint8_t> > bytes;
  common::optional<std::string> error_msg;

  std::tie(
    bytes,
    error_msg
  ) = stringification::Base64Decode(
  ...
  if (error_msg.has_value()) {
    std::wostringstream wss;
    wss
      << "Failed to base64-decode the bytes from a string: "
      << common::Utf8ToWstring(*error_msg);
...
> GetModelTypeFrom(
  ...
  const std::string* model_type = json.get_ptr<const std::string*>("modelType");
  return std::make_pair<
    const std::string*,
    common::optional<DeserializationError>
  >(
...
> DeserializeValueReferencePair(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInValueReferencePair.contains(key_val.key())) {
        std::wostringstream wss;
        wss
...
> DeserializeValueList(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInValueList.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (!json_value_reference_pairs.is_array()) {
    ...
    wss
      ...
      << common::Utf8ToWstring(json.type_name());
    error = common::make_optional<DeserializationError>(wss.str());
  ...
  for (
    ...
    the_value_reference_pairs->emplace_back(std::move(deserialized));
...
> DeserializeSubmodelElementList(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInSubmodelElementList.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (json.contains("extensions")) {
    ...
    for (
      ...
      the_extensions->emplace_back(std::move(deserialized));
  ...
  if (json.contains("displayName")) {
    ...
    for (
      ...
      the_display_name->emplace_back(std::move(deserialized));
  ...
  if (json.contains("description")) {
    ...
    for (
      ...
      the_description->emplace_back(std::move(deserialized));
  ...
  if (json.contains("supplementalSemanticIds")) {
    ...
    for (
      ...
      the_supplemental_semantic_ids->emplace_back(std::move(deserialized));
  ...
  if (json.contains("qualifiers")) {
    ...
    for (
      ...
      the_qualifiers->emplace_back(std::move(deserialized));
  ...
  if (json.contains("embeddedDataSpecifications")) {
    ...
    for (
      ...
      the_embedded_data_specifications->emplace_back(std::move(deserialized));
  ...
  if (!the_type_value_list_element.has_value()) {
    std::wostringstream wss;
    wss
      << "Invalid literal for AasSubmodelElements: "
      << text_type_value_list_element;
  ...
  if (json.contains("valueTypeListElement")) {
    ...
    if (!the_value_type_list_element.has_value()) {
      std::wostringstream wss;
      wss
        << "Invalid literal for DataTypeDefXsd: "
        << text_value_type_list_element;
  ...
  if (json.contains("value")) {
    ...
    for (
      ...
      the_value->emplace_back(std::move(deserialized));
...
> DeserializeSubmodelElementCollection(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInSubmodelElementCollection.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeSubmodel(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInSubmodel.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (json.contains("kind")) {
    ...
    if (!the_kind.has_value()) {
      std::wostringstream wss;
      wss
        << "Invalid literal for ModellingKind: "
        << text_kind;
  ...
  if (json.contains("submodelElements")) {
    ...
    for (
      ...
      the_submodel_elements->emplace_back(std::move(deserialized));
...
> DeserializeSpecificAssetId(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInSpecificAssetId.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeResource(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInResource.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeReferenceElement(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInReferenceElement.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeReference(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInReference.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (!the_type.has_value()) {
    std::wostringstream wss;
    wss
      << "Invalid literal for ReferenceTypes: "
      << text_type;
  ...
  for (
    ...
    the_keys->emplace_back(std::move(deserialized));
...
> DeserializeRange(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInRange.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeQualifier(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInQualifier.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (json.contains("kind")) {
    ...
    if (!the_kind.has_value()) {
      std::wostringstream wss;
      wss
        << "Invalid literal for QualifierKind: "
        << text_kind;
...
> DeserializeProperty(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInProperty.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeOperationVariable(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInOperationVariable.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeOperation(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInOperation.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (json.contains("inputVariables")) {
    ...
    for (
      ...
      the_input_variables->emplace_back(std::move(deserialized));
  ...
  if (json.contains("outputVariables")) {
    ...
    for (
      ...
      the_output_variables->emplace_back(std::move(deserialized));
  ...
  if (json.contains("inoutputVariables")) {
    ...
    for (
      ...
      the_inoutput_variables->emplace_back(std::move(deserialized));
...
> DeserializeMultiLanguageProperty(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInMultiLanguageProperty.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeLevelType(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInLevelType.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeLangStringTextType(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInLangStringTextType.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeLangStringShortNameTypeIec61360(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInLangStringShortNameTypeIec61360.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeLangStringPreferredNameTypeIec61360(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInLangStringPreferredNameTypeIec61360.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeLangStringNameType(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInLangStringNameType.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeLangStringDefinitionTypeIec61360(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInLangStringDefinitionTypeIec61360.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeKey(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInKey.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeHasKind(
  ...
  if (it == kDeserializeHasKindByModelType.end()) {
    std::wostringstream wss;
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IHasKind is not defined for "
  ...
  return (*it)(json, additional_properties);
}
...
> DeserializeFile(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInFile.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeExtension(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInExtension.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (json.contains("refersTo")) {
    ...
    for (
      ...
      the_refers_to->emplace_back(std::move(deserialized));
...
> DeserializeEventPayload(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInEventPayload.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeEnvironment(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInEnvironment.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (json.contains("assetAdministrationShells")) {
    ...
    for (
      ...
      the_asset_administration_shells->emplace_back(std::move(deserialized));
  ...
  if (json.contains("submodels")) {
    ...
    for (
      ...
      the_submodels->emplace_back(std::move(deserialized));
  ...
  if (json.contains("conceptDescriptions")) {
    ...
    for (
      ...
      the_concept_descriptions->emplace_back(std::move(deserialized));
...
> DeserializeEntity(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInEntity.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (json.contains("statements")) {
    ...
    for (
      ...
      the_statements->emplace_back(std::move(deserialized));
  ...
  if (!the_entity_type.has_value()) {
    std::wostringstream wss;
    wss
      << "Invalid literal for EntityType: "
      << text_entity_type;
  ...
  if (json.contains("specificAssetIds")) {
    ...
    for (
      ...
      the_specific_asset_ids->emplace_back(std::move(deserialized));
...
> DeserializeEmbeddedDataSpecification(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInEmbeddedDataSpecification.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeDataSpecificationIec61360(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInDataSpecificationIec61360.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  for (
    ...
    the_preferred_name->emplace_back(std::move(deserialized));
  ...
  if (json.contains("shortName")) {
    ...
    for (
      ...
      the_short_name->emplace_back(std::move(deserialized));
  ...
  if (json.contains("dataType")) {
    ...
    if (!the_data_type.has_value()) {
      std::wostringstream wss;
      wss
        << "Invalid literal for DataTypeIec61360: "
        << text_data_type;
  ...
  if (json.contains("definition")) {
    ...
    for (
      ...
      the_definition->emplace_back(std::move(deserialized));
...
> DeserializeDataSpecificationContent(
  ...
  if (it == kDeserializeDataSpecificationContentByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IDataSpecificationContent is not defined for "
      << "model type: " << *model_type;
...
> DeserializeConceptDescription(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInConceptDescription.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (json.contains("isCaseOf")) {
    ...
    for (
      ...
      the_is_case_of->emplace_back(std::move(deserialized));
...
> DeserializeCapability(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInCapability.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeBlob(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInBlob.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeDataElement(
  ...
  if (it == kDeserializeDataElementByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IDataElement is not defined for "
      << "model type: " << *model_type;
...
> DeserializeBasicEventElement(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInBasicEventElement.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (!the_state.has_value()) {
    std::wostringstream wss;
    wss
      << "Invalid literal for StateOfEvent: "
      << text_state;
...
> DeserializeEventElement(
  ...
  if (it == kDeserializeEventElementByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IEventElement is not defined for "
      << "model type: " << *model_type;
...
> DeserializeAssetInformation(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInAssetInformation.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeAssetAdministrationShell(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInAssetAdministrationShell.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeIdentifiable(
  ...
  if (it == kDeserializeIdentifiableByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IIdentifiable is not defined for "
      << "model type: " << *model_type;
...
> DeserializeAnnotatedRelationshipElement(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInAnnotatedRelationshipElement.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
  ...
  if (json.contains("annotations")) {
    ...
    for (
      ...
      the_annotations->emplace_back(std::move(deserialized));
...
> ConcretelyDeserializeRelationshipElement(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInRelationshipElement.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeRelationshipElement(
  ...
  if (it == kDeserializeRelationshipElementByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IRelationshipElement is not defined for "
      << "model type: " << *model_type;
...
> DeserializeSubmodelElement(
  ...
  if (it == kDeserializeSubmodelElementByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::ISubmodelElement is not defined for "
      << "model type: " << *model_type;
...
> DeserializeQualifiable(
  ...
  if (it == kDeserializeQualifiableByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IQualifiable is not defined for "
      << "model type: " << *model_type;
...
> DeserializeHasSemantics(
  ...
  if (it == kDeserializeHasSemanticsByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IHasSemantics is not defined for "
      << "model type: " << *model_type;
...
> DeserializeReferable(
  ...
  if (it == kDeserializeReferableByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IReferable is not defined for "
      << "model type: " << *model_type;
...
> DeserializeHasExtensions(
  ...
  if (it == kDeserializeHasExtensionsByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IHasExtensions is not defined for "
      << "model type: " << *model_type;
...
> DeserializeAdministrativeInformation(
  ...
  if (!additional_properties) {
    for (const auto& key_val : json.items()) {
      if (!kPropertiesInAdministrativeInformation.contains(key_val.key())) {
        std::wostringstream wss;
        wss
          << L"Unexpected additional property: "
          << common::Utf8ToWstring(key_val.key());
...
> DeserializeHasDataSpecification(
  ...
  if (it == kDeserializeHasDataSpecificationByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IHasDataSpecification is not defined for "
      << "model type: " << *model_type;
...
> DeserializeAbstractLangString(
  ...
  if (it == kDeserializeAbstractLangStringByModelType.end()) {
    ...
    wss
      << "The dispatch to the JSON de-serialization of "
      << "types::IAbstractLangString is not defined for "
      << "model type: " << *model_type;
...
> HasSemanticsFrom(
  ...
  return DeserializeHasSemantics(
    json,
    additional_properties
  );
}
...
> HasExtensionsFrom(
  ...
  return DeserializeHasExtensions(
    json,
    additional_properties
  );
}
...
> IdentifiableFrom(
  ...
  return DeserializeIdentifiable(
    json,
    additional_properties
  );
}
...
> HasDataSpecificationFrom(
  ...
  return DeserializeHasDataSpecification(
    json,
    additional_properties
  );
}
...
> AssetInformationFrom(
  ...
  return DeserializeAssetInformation(
    json,
    additional_properties
  );
}
...
> SubmodelElementFrom(
  ...
  return DeserializeSubmodelElement(
    json,
    additional_properties
  );
}
...
> RelationshipElementFrom(
  ...
  return DeserializeRelationshipElement(
    json,
    additional_properties
  );
}
...
> EventPayloadFrom(
  ...
  return DeserializeEventPayload(
    json,
    additional_properties
  );
}
...
> EventElementFrom(
  ...
  return DeserializeEventElement(
    json,
    additional_properties
  );
}
...
> OperationVariableFrom(
  ...
  return DeserializeOperationVariable(
    json,
    additional_properties
  );
}
...
> AbstractLangStringFrom(
  ...
  return DeserializeAbstractLangString(
    json,
    additional_properties
  );
}
...
> DataSpecificationContentFrom(
  ...
  return DeserializeDataSpecificationContent(
    json,
    additional_properties
  );
}
...
> EmbeddedDataSpecificationFrom(
  ...
  return DeserializeEmbeddedDataSpecification(
    json,
    additional_properties
  );
}
...
> ValueReferencePairFrom(
  ...
  return DeserializeValueReferencePair(
    json,
    additional_properties
  );
}
...
> SerializeInt64(int64_t value) {
  if (
    ...
    const std::wstring message = common::Concat(
      ...
      "as it is outside the range [-2^53 + 1, 2^53 - 1] and can not "
      "be exactly represented as a 64-bit floating point number."
    );
...
> SerializeExtension(
  ...
  if (maybe_supplemental_semantic_ids.has_value()) {
    ...
    for (
      ...
      json_supplemental_semantic_ids.emplace_back(item);
  ...
  const common::optional<DataTypeDefXsd>& maybe_value_type(
    that.value_type()
  );
  ...
  if (maybe_refers_to.has_value()) {
    ...
    for (
      ...
      json_refers_to.emplace_back(item);
...
> SerializeAdministrativeInformation(
  ...
  if (maybe_embedded_data_specifications.has_value()) {
    ...
    for (
      ...
      json_embedded_data_specifications.emplace_back(item);
...
> SerializeQualifier(
  ...
  const common::optional<QualifierKind>& maybe_kind(
    that.kind()
  );
...
> SerializeAssetAdministrationShell(
  ...
  if (maybe_extensions.has_value()) {
    ...
    for (
      ...
      json_extensions.emplace_back(item);
  ...
  if (maybe_display_name.has_value()) {
    ...
    for (
      ...
      json_display_name.emplace_back(item);
  ...
  if (maybe_description.has_value()) {
    ...
    for (
      ...
      json_description.emplace_back(item);
  ...
  if (maybe_submodels.has_value()) {
    ...
    for (
      ...
      json_submodels.emplace_back(item);
...
> SerializeAssetInformation(
  ...
  if (maybe_specific_asset_ids.has_value()) {
    ...
    for (
      ...
      json_specific_asset_ids.emplace_back(item);
...
> SerializeSubmodel(
  ...
  const common::optional<ModellingKind>& maybe_kind(
    that.kind()
  );
  if (maybe_kind.has_value()) {
    result["kind"] = stringification::to_string(
  ...
  if (maybe_qualifiers.has_value()) {
    ...
    for (
      ...
      json_qualifiers.emplace_back(item);
  ...
  if (maybe_submodel_elements.has_value()) {
    ...
    for (
      ...
      json_submodel_elements.emplace_back(item);
...
> SerializeSubmodelElementList(
  ...
  const common::optional<DataTypeDefXsd>& maybe_value_type_list_element(
...
> SerializeAnnotatedRelationshipElement(
  ...
  if (maybe_annotations.has_value()) {
    ...
    for (
      ...
      json_annotations.emplace_back(item);
...
> SerializeEntity(
  ...
  if (maybe_statements.has_value()) {
    ...
    for (
      ...
      json_statements.emplace_back(item);
...
> SerializeOperation(
  ...
  if (maybe_input_variables.has_value()) {
    ...
    for (
      ...
      json_input_variables.emplace_back(item);
  ...
  if (maybe_output_variables.has_value()) {
    ...
    for (
      ...
      json_output_variables.emplace_back(item);
  ...
  if (maybe_inoutput_variables.has_value()) {
    ...
    for (
      ...
      json_inoutput_variables.emplace_back(item);
...
> SerializeConceptDescription(
  ...
  if (maybe_is_case_of.has_value()) {
    ...
    for (
      ...
      json_is_case_of.emplace_back(item);
...
> SerializeEnvironment(
  ...
  if (maybe_asset_administration_shells.has_value()) {
    ...
    for (
      ...
      json_asset_administration_shells.emplace_back(item);
  ...
  if (maybe_concept_descriptions.has_value()) {
    ...
    for (
      ...
      json_concept_descriptions.emplace_back(item);
...
> SerializeValueList(
  ...
  for (
    ...
    json_value_reference_pairs.emplace_back(item);
...
> SerializeDataSpecificationIec61360(
  ...
  for (
    ...
    json_preferred_name.emplace_back(item);
  ...
  if (maybe_short_name.has_value()) {
    ...
    for (
      ...
      json_short_name.emplace_back(item);
  ...
  const common::optional<DataTypeIec61360>& maybe_data_type(
    that.data_type()
  );
  ...
  if (maybe_definition.has_value()) {
    ...
    for (
      ...
      json_definition.emplace_back(item);
